...
"""
#学生自主完成
def send_message(tel="15810107168",module="hadoop",message="error"):
    ...
    YourMNSEndpoint = "http://1042200050238966.mns.cn-beijing-internal.aliyuncs.com/"
    YourAccessId = "LTAIYmBKM9mUP6PP"
    YourAccessKey = "1agdCM5oDUNOt0Ul66KDFgjaRuxNiO"
    my_account = Account(YourMNSEndpoint, YourAccessId, YourAccessKey)

    YourTopicName = "sms.topic-cn-beijing"
    my_topic = my_account.get_topic(YourTopicName)
    #print my_topic
    '''
    Step 2. 设置SMS消息体（必须）
    ...
    YourSignName = "视频测试"
    YourSMSTemplateCode = "SMS_85210006"
    ...
    direct_sms_attr1.set_params({ "module": module, "time": cur_time})
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        ...
        print "example:./send_sms.py 15810107168 word_rank error"
        sys.exit()
