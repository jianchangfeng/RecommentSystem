...
def assemble_html_iqiyi_data(html,category_info=""):
    ...
    ul = soup.find('ul', {"class": "site-piclist site-piclist-180101 site-piclist-auto"})
    ...
    for anode in alist:
        ...
        p = anode.find('p',{"class":"site-piclist_info_title"})
        ainfo = p.find('a')
...
if __name__=="__main__":
    category_info_list = [
    {"category_name": "欢乐精选", "category_url": "http://list.iqiyi.com/www/22/22169-------------11-1-2-iqiyi-1-.html"},
    {"category_name": "娱乐八卦", "category_url": "http://list.iqiyi.com/www/22/29115-------------11-1-2-iqiyi-1-.html"},
    {"category_name": "搞笑短片", "category_url": "http://list.iqiyi.com/www/22/29116-------------11-1-2-iqiyi-1-.html"},
    {"category_name": "影视剧吐槽", "category_url": "http://list.iqiyi.com/www/22/29139-------------11-1-2-iqiyi-1-.html"},
    {"category_name": "雷人囧事", "category_url": "http://list.iqiyi.com/www/22/22172-------------11-1-2-iqiyi-1-.html"},
    {"category_name": "爆笑节目", "category_url": "http://list.iqiyi.com/www/22/22171-------------11-1-2-iqiyi-1-.html"},
