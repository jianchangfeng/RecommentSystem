...
def get_video_link():
    ...
    sql_com = "select id,vid,link,source FROM video_info where DATEDIFF(NOW(),fetch_time)<3 and duration <301 and (public_type='all' or public_type is null) and is_download=0"
